...
EPOCHS = 100
history = model.fit(X_train, y_train, validation_data=(X_val, y_val), epochs=EPOCHS, callbacks=[history_cb, early_stopping]) #add 'cp' to callbacks
...
model1 = load_model('model/model.keras')
