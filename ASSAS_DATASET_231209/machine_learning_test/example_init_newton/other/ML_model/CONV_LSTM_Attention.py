...
model.add(LSTM(256, activation='relu', recurrent_activation='sigmoid', return_sequences=True))
model.add(LSTM(256, activation='relu', return_sequences=True))
model.add(Flatten())
...
model.save_weights('Convlstmattention_model.weights.h5')
model.load_weights('Convlstmattention_model.weights.h5')
