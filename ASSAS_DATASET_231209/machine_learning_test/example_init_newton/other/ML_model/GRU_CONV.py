...
model.add(LSTM(2234, activation='relu', recurrent_activation='sigmoid'))
# model.add(Reshape((10, 32)))
model.add(Reshape((-1,2234)))
model.add(Conv1D(128, kernel_size=3, activation='relu', padding='same'))
model.add(MaxPooling1D(pool_size=2))
model.add(Dense(128, 'relu', kernel_regularizer=tf.keras.regularizers.l1_l2(l1=0.01, l2=0.01)))
model.add(Flatten())
model.add(Dense(32, 'swish', kernel_regularizer=tf.keras.regularizers.l2(0.01)))
model.add(Dropout(0.11))
model.add(Dense(64, 'relu', kernel_regularizer=tf.keras.regularizers.l1_l2(l1=0.01, l2=0.01)))
...
model.save_weights('GruConv_model.weights.h5')
model.load_weights('GruConv_model.weights.h5')
