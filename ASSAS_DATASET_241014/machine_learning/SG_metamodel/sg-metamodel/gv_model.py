...
def generate_sensor_datas(gv: int) -> Iterable[ObjectMetadata]:
    ...
    yield ObjectMetadata(SENSOR_ROOT, f"NR_SG{gv}", "NR_SGX", gv)
    yield ObjectMetadata(SENSOR_ROOT, f"WR_SG{gv}", "WR_SGX", gv)
    ...
    yield ObjectMetadata(SENSOR_ROOT, f"QS_SG{gv}", "QS_SGX", gv)
    yield ObjectMetadata(SENSOR_ROOT, f"P_SG{gv}", "P_SGX", gv)
