...
class Encoder(nn.Module):
    ...
    def forward(self, x):
        ...
        # Cross-Feature Processing
        for layer in self.cross_feature_layers:
        ...
        for i in range(self.n_features):
            ...
            for layer in self.feature_processors[i]:
...
class Decoder(nn.Module):
    ...
    def forward(self, embeddings, skip_connections):
        ...
        skip_connections = [skip.to(self.device) for skip in skip_connections]
        ...
        # Stack reconstructions along feature dimension
...
class Autoencoder(nn.Module):
    def __init__(self,
        ...
        self.encoder = Encoder(
            n_features, window_size, embedding_dim, num_layers,
    ...
    def forward(self, x):
        embedding, skip_connections = self.encoder(x)
