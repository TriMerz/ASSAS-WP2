...
DUO = [ "T_liq", "T_gas", "x_alfa", "P_steam", "P_o2", "P_h2", "P_n2", "P_bho2", "P_co2", "v_liq", "v_gas", "FLUX" , "P" , "T_wall" , "x_alfa1" , "WTEMP", "VG", "VF", "TLIQ", "TFLU", "MASS", "PRES", "ZVELO", "VLIQ", "FPHDDRY", "FPHDWET", "FPHGAS", "FPHAERO", "FPHWATER", "ZHEWALL", "ZHEZONE", "ZHEZONS", "FDELP", "WLEV"]
